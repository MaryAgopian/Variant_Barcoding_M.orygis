...
# In this case, it was used to transform our previously generated SAM files into BAM files. BAM is a binary version of the text SAM file. We convert SAM to BAM since the binary format is easier for the programs to process and work with.
